...
function findWasmBinary() {
  return locateFile("litertlm_wasm_compat_asyncify_internal.wasm");
}
...
var _malloc, _free, _ma_device__on_notification_unlocked, _ma_malloc_emscripten, _ma_free_emscripten, _ma_device_process_pcm_frames_capture__webaudio, _ma_device_process_pcm_frames_playback__webaudio, _wgpuDeviceAddRef, _emwgpuCreateBindGroup, _emwgpuCreateBindGroupLayout, _emwgpuCreateCommandBuffer, _emwgpuCreateCommandEncoder, _emwgpuCreateComputePassEncoder, _emwgpuCreateComputePipeline, _emwgpuCreateExternalTexture, _emwgpuCreatePipelineLayout, _emwgpuCreateQuerySet, _emwgpuCreateRenderBundle, _emwgpuCreateRenderBundleEncoder, _emwgpuCreateRenderPassEncoder, _emwgpuCreateRenderPipeline, _emwgpuCreateSampler, _emwgpuCreateSurface, _emwgpuCreateTexture, _emwgpuCreateTextureView, _emwgpuCreateAdapter, _emwgpuImportBuffer, _emwgpuCreateDevice, _emwgpuCreateQueue, _emwgpuCreateShaderModule, _emwgpuOnCreateComputePipelineCompleted, _emwgpuOnMapAsyncCompleted, _emwgpuOnWorkDoneCompleted, ___getTypeName, _emscripten_builtin_memalign, _memalign, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_vi, dynCall_v, dynCall_vii, dynCall_ii, dynCall_iii, dynCall_iiii, dynCall_viii, dynCall_i, dynCall_fi, dynCall_fii, dynCall_vif, dynCall_viif, dynCall_dii, dynCall_viid, dynCall_iiiiiiii, dynCall_viiiiiii, dynCall_viiii, dynCall_iiiii, dynCall_viiiii, dynCall_iiijj, dynCall_iijj, dynCall_viijj, dynCall_iiiiii, dynCall_viiij, dynCall_jiii, dynCall_viiiiiiiii, dynCall_jiji, dynCall_vijj, dynCall_ji, dynCall_jij, dynCall_iiiijij, dynCall_jiij, dynCall_jii, dynCall_vij, dynCall_viij, dynCall_iij, dynCall_viiiiiiii, dynCall_iiji, dynCall_iiiiiiiii, dynCall_iiiiiii, dynCall_iiiji, dynCall_ff, dynCall_fff, dynCall_viiiiii, dynCall_iiiiiiiiiii, dynCall_iiiiiiiiiiii, dynCall_iiiiiiiiiiiii, dynCall_iiiiiiiiiiiiiii, dynCall_viiiiiiiiii, dynCall_viiiiiiiiiii, dynCall_iiif, dynCall_viji, dynCall_viijii, dynCall_viiif, dynCall_viiifiii, dynCall_fiif, dynCall_iiiifi, dynCall_iiiifiii, dynCall_iiifi, dynCall_viiiif, dynCall_viiiifii, dynCall_iiiiiiiiii, dynCall_iiiijj, dynCall_viiijjj, dynCall_viifii, dynCall_iff, dynCall_ijj, dynCall_vfiii, dynCall_jjj, dynCall_fiii, dynCall_viiiffii, dynCall_iiiiiffi, dynCall_viiiiiff, dynCall_viiiiiiiiiiiii, dynCall_viiiiiiiiiiii, dynCall_viiiiiiiiiiiiiiiii, dynCall_iifff, dynCall_iiff, dynCall_iiifiii, dynCall_iiffi, dynCall_iiffii, dynCall_viiiiiiiiiiiiii, dynCall_iif, dynCall_vifi, dynCall_vidi, dynCall_vijjj, dynCall_vj, dynCall_iidiiiii, dynCall_iiiiij, dynCall_iiiiid, dynCall_iiiiijj, dynCall_iiiiiijj, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, memory, _kVersionStampBuildChangelistStr, _kVersionStampCitcSnapshotStr, _kVersionStampCitcWorkspaceIdStr, _kVersionStampSourceUriStr, _kVersionStampBuildClientStr, _kVersionStampBuildClientMintStatusStr, _kVersionStampBuildCompilerStr, _kVersionStampBuildDateTimePstStr, _kVersionStampBuildDepotPathStr, _kVersionStampBuildIdStr, _kVersionStampBuildInfoStr, _kVersionStampBuildLabelStr, _kVersionStampBuildTargetStr, _kVersionStampBuildTimestampStr, _kVersionStampBuildToolStr, _kVersionStampG3BuildTargetStr, _kVersionStampVerifiableStr, _kVersionStampBuildFdoTypeStr, _kVersionStampBuildBaselineChangelistStr, _kVersionStampBuildLtoTypeStr, _kVersionStampBuildPropellerTypeStr, _kVersionStampBuildPghoTypeStr, _kVersionStampBuildFdoProfileChangelistStr, _kVersionStampBuildMemprofProfileChangelistStr, _kVersionStampBuildUsernameStr, _kVersionStampBuildHostnameStr, _kVersionStampBuildDirectoryStr, _kVersionStampBuildChangelistInt, _kVersionStampCitcSnapshotInt, _kVersionStampBuildClientMintStatusInt, _kVersionStampBuildTimestampInt, _kVersionStampVerifiableInt, _kVersionStampBuildCoverageEnabledInt, _kVersionStampBuildBaselineChangelistInt, _kVersionStampPrecookedTimestampStr, _kVersionStampPrecookedClientInfoStr, __indirect_function_table, _kVersionStampBuildHasHardeningProtobuf, wasmMemory;

function assignWasmExports(wasmExports) {
  _malloc = Module["_malloc"] = wasmExports["nc"];
  _free = Module["_free"] = wasmExports["oc"];
  _ma_device__on_notification_unlocked = Module["_ma_device__on_notification_unlocked"] = wasmExports["pc"];
  _ma_malloc_emscripten = Module["_ma_malloc_emscripten"] = wasmExports["qc"];
  _ma_free_emscripten = Module["_ma_free_emscripten"] = wasmExports["rc"];
  _ma_device_process_pcm_frames_capture__webaudio = Module["_ma_device_process_pcm_frames_capture__webaudio"] = wasmExports["sc"];
  _ma_device_process_pcm_frames_playback__webaudio = Module["_ma_device_process_pcm_frames_playback__webaudio"] = wasmExports["tc"];
  _wgpuDeviceAddRef = wasmExports["uc"];
  _emwgpuCreateBindGroup = wasmExports["vc"];
  _emwgpuCreateBindGroupLayout = wasmExports["wc"];
  _emwgpuCreateCommandBuffer = wasmExports["xc"];
  _emwgpuCreateCommandEncoder = wasmExports["yc"];
  _emwgpuCreateComputePassEncoder = wasmExports["zc"];
  ...
  _emwgpuOnMapAsyncCompleted = wasmExports["Sc"];
  ...
  _emscripten_stack_get_current = wasmExports["_c"];
  dynCall_vi = dynCalls["vi"] = wasmExports["$c"];
  dynCall_v = dynCalls["v"] = wasmExports["ad"];
  dynCall_vii = dynCalls["vii"] = wasmExports["bd"];
  dynCall_ii = dynCalls["ii"] = wasmExports["cd"];
  dynCall_iii = dynCalls["iii"] = wasmExports["dd"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["ed"];
  dynCall_viii = dynCalls["viii"] = wasmExports["fd"];
  dynCall_i = dynCalls["i"] = wasmExports["gd"];
  dynCall_fi = dynCalls["fi"] = wasmExports["hd"];
  dynCall_fii = dynCalls["fii"] = wasmExports["id"];
  dynCall_vif = dynCalls["vif"] = wasmExports["jd"];
  dynCall_viif = dynCalls["viif"] = wasmExports["kd"];
  dynCall_dii = dynCalls["dii"] = wasmExports["ld"];
  dynCall_viid = dynCalls["viid"] = wasmExports["md"];
  dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["nd"];
  dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["od"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["pd"];
  dynCall_iiiii = dynCalls["iiiii"] = wasmExports["qd"];
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["rd"];
  dynCall_iiijj = dynCalls["iiijj"] = wasmExports["sd"];
  dynCall_iijj = dynCalls["iijj"] = wasmExports["td"];
  dynCall_viijj = dynCalls["viijj"] = wasmExports["ud"];
  dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["vd"];
  dynCall_viiij = dynCalls["viiij"] = wasmExports["wd"];
  dynCall_jiii = dynCalls["jiii"] = wasmExports["xd"];
  dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["yd"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["zd"];
  dynCall_vijj = dynCalls["vijj"] = wasmExports["Ad"];
  dynCall_ji = dynCalls["ji"] = wasmExports["Bd"];
  dynCall_jij = dynCalls["jij"] = wasmExports["Cd"];
  dynCall_iiiijij = dynCalls["iiiijij"] = wasmExports["Dd"];
  dynCall_jiij = dynCalls["jiij"] = wasmExports["Ed"];
  dynCall_jii = dynCalls["jii"] = wasmExports["Fd"];
  dynCall_vij = dynCalls["vij"] = wasmExports["Gd"];
  dynCall_viij = dynCalls["viij"] = wasmExports["Hd"];
  dynCall_iij = dynCalls["iij"] = wasmExports["Id"];
  dynCall_viiiiiiii = dynCalls["viiiiiiii"] = wasmExports["Jd"];
  dynCall_iiji = dynCalls["iiji"] = wasmExports["Kd"];
  dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["Ld"];
  dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["Md"];
  dynCall_iiiji = dynCalls["iiiji"] = wasmExports["Nd"];
  dynCall_ff = dynCalls["ff"] = wasmExports["Od"];
  dynCall_fff = dynCalls["fff"] = wasmExports["Pd"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["Qd"];
  dynCall_iiiiiiiiiii = dynCalls["iiiiiiiiiii"] = wasmExports["Rd"];
  dynCall_iiiiiiiiiiii = dynCalls["iiiiiiiiiiii"] = wasmExports["Sd"];
  dynCall_iiiiiiiiiiiii = dynCalls["iiiiiiiiiiiii"] = wasmExports["Td"];
  dynCall_iiiiiiiiiiiiiii = dynCalls["iiiiiiiiiiiiiii"] = wasmExports["Ud"];
  dynCall_viiiiiiiiii = dynCalls["viiiiiiiiii"] = wasmExports["Vd"];
  dynCall_viiiiiiiiiii = dynCalls["viiiiiiiiiii"] = wasmExports["Wd"];
  dynCall_iiif = dynCalls["iiif"] = wasmExports["Xd"];
  dynCall_viji = dynCalls["viji"] = wasmExports["Yd"];
  dynCall_viijii = dynCalls["viijii"] = wasmExports["Zd"];
  dynCall_viiif = dynCalls["viiif"] = wasmExports["_d"];
  dynCall_viiifiii = dynCalls["viiifiii"] = wasmExports["$d"];
  dynCall_fiif = dynCalls["fiif"] = wasmExports["ae"];
  dynCall_iiiifi = dynCalls["iiiifi"] = wasmExports["be"];
  dynCall_iiiifiii = dynCalls["iiiifiii"] = wasmExports["ce"];
  dynCall_iiifi = dynCalls["iiifi"] = wasmExports["de"];
  dynCall_viiiif = dynCalls["viiiif"] = wasmExports["ee"];
  dynCall_viiiifii = dynCalls["viiiifii"] = wasmExports["fe"];
  dynCall_iiiiiiiiii = dynCalls["iiiiiiiiii"] = wasmExports["ge"];
  dynCall_iiiijj = dynCalls["iiiijj"] = wasmExports["he"];
  dynCall_viiijjj = dynCalls["viiijjj"] = wasmExports["ie"];
  dynCall_viifii = dynCalls["viifii"] = wasmExports["je"];
  dynCall_iff = dynCalls["iff"] = wasmExports["ke"];
  dynCall_ijj = dynCalls["ijj"] = wasmExports["le"];
  dynCall_vfiii = dynCalls["vfiii"] = wasmExports["me"];
  dynCall_jjj = dynCalls["jjj"] = wasmExports["ne"];
  dynCall_fiii = dynCalls["fiii"] = wasmExports["oe"];
  dynCall_viiiffii = dynCalls["viiiffii"] = wasmExports["pe"];
  dynCall_iiiiiffi = dynCalls["iiiiiffi"] = wasmExports["qe"];
  dynCall_viiiiiff = dynCalls["viiiiiff"] = wasmExports["re"];
  dynCall_viiiiiiiiiiiii = dynCalls["viiiiiiiiiiiii"] = wasmExports["se"];
  dynCall_viiiiiiiiiiii = dynCalls["viiiiiiiiiiii"] = wasmExports["te"];
  dynCall_viiiiiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiiiiii"] = wasmExports["ue"];
  dynCall_iifff = dynCalls["iifff"] = wasmExports["ve"];
  dynCall_iiff = dynCalls["iiff"] = wasmExports["we"];
  dynCall_iiifiii = dynCalls["iiifiii"] = wasmExports["xe"];
  dynCall_iiffi = dynCalls["iiffi"] = wasmExports["ye"];
  dynCall_iiffii = dynCalls["iiffii"] = wasmExports["ze"];
  dynCall_viiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiii"] = wasmExports["Ae"];
  dynCall_iif = dynCalls["iif"] = wasmExports["Be"];
  dynCall_vifi = dynCalls["vifi"] = wasmExports["Ce"];
  dynCall_vidi = dynCalls["vidi"] = wasmExports["De"];
  dynCall_vijjj = dynCalls["vijjj"] = wasmExports["Ee"];
  dynCall_vj = dynCalls["vj"] = wasmExports["Fe"];
  dynCall_iidiiiii = dynCalls["iidiiiii"] = wasmExports["Ge"];
  dynCall_iiiiij = dynCalls["iiiiij"] = wasmExports["He"];
  dynCall_iiiiid = dynCalls["iiiiid"] = wasmExports["Ie"];
  dynCall_iiiiijj = dynCalls["iiiiijj"] = wasmExports["Je"];
  dynCall_iiiiiijj = dynCalls["iiiiiijj"] = wasmExports["Ke"];
  _asyncify_start_unwind = wasmExports["Le"];
  _asyncify_stop_unwind = wasmExports["Me"];
  _asyncify_start_rewind = wasmExports["Ne"];
  _asyncify_stop_rewind = wasmExports["Oe"];
  memory = wasmMemory = wasmExports["Db"];
  _kVersionStampBuildChangelistStr = Module["_kVersionStampBuildChangelistStr"] = (wasmExports["Fb"].value) >>> 0;
  _kVersionStampCitcSnapshotStr = Module["_kVersionStampCitcSnapshotStr"] = (wasmExports["Gb"].value) >>> 0;
  _kVersionStampCitcWorkspaceIdStr = Module["_kVersionStampCitcWorkspaceIdStr"] = (wasmExports["Hb"].value) >>> 0;
  _kVersionStampSourceUriStr = Module["_kVersionStampSourceUriStr"] = (wasmExports["Ib"].value) >>> 0;
  _kVersionStampBuildClientStr = Module["_kVersionStampBuildClientStr"] = (wasmExports["Jb"].value) >>> 0;
  _kVersionStampBuildClientMintStatusStr = Module["_kVersionStampBuildClientMintStatusStr"] = (wasmExports["Kb"].value) >>> 0;
  _kVersionStampBuildCompilerStr = Module["_kVersionStampBuildCompilerStr"] = (wasmExports["Lb"].value) >>> 0;
  _kVersionStampBuildDateTimePstStr = Module["_kVersionStampBuildDateTimePstStr"] = (wasmExports["Mb"].value) >>> 0;
  _kVersionStampBuildDepotPathStr = Module["_kVersionStampBuildDepotPathStr"] = (wasmExports["Nb"].value) >>> 0;
  _kVersionStampBuildIdStr = Module["_kVersionStampBuildIdStr"] = (wasmExports["Ob"].value) >>> 0;
  _kVersionStampBuildInfoStr = Module["_kVersionStampBuildInfoStr"] = (wasmExports["Pb"].value) >>> 0;
  _kVersionStampBuildLabelStr = Module["_kVersionStampBuildLabelStr"] = (wasmExports["Qb"].value) >>> 0;
  _kVersionStampBuildTargetStr = Module["_kVersionStampBuildTargetStr"] = (wasmExports["Rb"].value) >>> 0;
  _kVersionStampBuildTimestampStr = Module["_kVersionStampBuildTimestampStr"] = (wasmExports["Sb"].value) >>> 0;
  _kVersionStampBuildToolStr = Module["_kVersionStampBuildToolStr"] = (wasmExports["Tb"].value) >>> 0;
  _kVersionStampG3BuildTargetStr = Module["_kVersionStampG3BuildTargetStr"] = (wasmExports["Ub"].value) >>> 0;
  _kVersionStampVerifiableStr = Module["_kVersionStampVerifiableStr"] = (wasmExports["Vb"].value) >>> 0;
  _kVersionStampBuildFdoTypeStr = Module["_kVersionStampBuildFdoTypeStr"] = (wasmExports["Wb"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistStr = Module["_kVersionStampBuildBaselineChangelistStr"] = (wasmExports["Xb"].value) >>> 0;
  _kVersionStampBuildLtoTypeStr = Module["_kVersionStampBuildLtoTypeStr"] = (wasmExports["Yb"].value) >>> 0;
  _kVersionStampBuildPropellerTypeStr = Module["_kVersionStampBuildPropellerTypeStr"] = (wasmExports["Zb"].value) >>> 0;
  _kVersionStampBuildPghoTypeStr = Module["_kVersionStampBuildPghoTypeStr"] = (wasmExports["_b"].value) >>> 0;
  _kVersionStampBuildFdoProfileChangelistStr = Module["_kVersionStampBuildFdoProfileChangelistStr"] = (wasmExports["$b"].value) >>> 0;
  _kVersionStampBuildMemprofProfileChangelistStr = Module["_kVersionStampBuildMemprofProfileChangelistStr"] = (wasmExports["ac"].value) >>> 0;
  _kVersionStampBuildUsernameStr = Module["_kVersionStampBuildUsernameStr"] = (wasmExports["bc"].value) >>> 0;
  _kVersionStampBuildHostnameStr = Module["_kVersionStampBuildHostnameStr"] = (wasmExports["cc"].value) >>> 0;
  _kVersionStampBuildDirectoryStr = Module["_kVersionStampBuildDirectoryStr"] = (wasmExports["dc"].value) >>> 0;
  _kVersionStampBuildChangelistInt = Module["_kVersionStampBuildChangelistInt"] = (wasmExports["ec"].value) >>> 0;
  _kVersionStampCitcSnapshotInt = Module["_kVersionStampCitcSnapshotInt"] = (wasmExports["fc"].value) >>> 0;
  _kVersionStampBuildClientMintStatusInt = Module["_kVersionStampBuildClientMintStatusInt"] = (wasmExports["gc"].value) >>> 0;
  _kVersionStampBuildTimestampInt = Module["_kVersionStampBuildTimestampInt"] = (wasmExports["hc"].value) >>> 0;
  _kVersionStampVerifiableInt = Module["_kVersionStampVerifiableInt"] = (wasmExports["ic"].value) >>> 0;
  _kVersionStampBuildCoverageEnabledInt = Module["_kVersionStampBuildCoverageEnabledInt"] = (wasmExports["jc"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistInt = Module["_kVersionStampBuildBaselineChangelistInt"] = (wasmExports["kc"].value) >>> 0;
  _kVersionStampPrecookedTimestampStr = Module["_kVersionStampPrecookedTimestampStr"] = (wasmExports["lc"].value) >>> 0;
  _kVersionStampPrecookedClientInfoStr = Module["_kVersionStampPrecookedClientInfoStr"] = (wasmExports["mc"].value) >>> 0;
  __indirect_function_table = wasmExports["__indirect_function_table"];
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = (wasmExports["Uc"].value) >>> 0;
}

var wasmImports = {
  /** @export */ Bb: DefaultErrorReporter,
  /** @export */ Ab: GetAdapterArchitecture,
  /** @export */ zb: GetAdapterDescription,
  /** @export */ yb: GetAdapterDeviceName,
  /** @export */ xb: GetAdapterVendor,
  /** @export */ wb: JsGetDeviceMaxSubgroupSize,
  /** @export */ vb: JsGetDeviceMinSubgroupSize,
  /** @export */ ub: ThrowError,
  /** @export */ tb: __Unwind_RaiseException,
  /** @export */ Cb: __asyncjs__CallStreamWeightsOnWeb,
  /** @export */ O: __asyncjs__ReadBufferDataJs,
  /** @export */ sb: ___syscall_dup,
  /** @export */ rb: ___syscall_faccessat,
  /** @export */ t: ___syscall_fcntl64,
  /** @export */ qb: ___syscall_fstat64,
  /** @export */ pb: ___syscall_ftruncate64,
  /** @export */ ob: ___syscall_getcwd,
  /** @export */ nb: ___syscall_getdents64,
  /** @export */ mb: ___syscall_ioctl,
  /** @export */ lb: ___syscall_lstat64,
  /** @export */ kb: ___syscall_mkdirat,
  /** @export */ jb: ___syscall_newfstatat,
  /** @export */ N: ___syscall_openat,
  /** @export */ ib: ___syscall_readlinkat,
  /** @export */ hb: ___syscall_rmdir,
  /** @export */ gb: ___syscall_stat64,
  /** @export */ da: ___syscall_unlinkat,
  /** @export */ fb: ___syscall_utimensat,
  /** @export */ Za: __abort_js,
  /** @export */ A: __embind_finalize_value_object,
  /** @export */ ba: __embind_register_bigint,
  /** @export */ Ya: __embind_register_bool,
  ...
  /** @export */ Xa: __embind_register_emval,
  /** @export */ aa: __embind_register_enum,
  /** @export */ r: __embind_register_enum_value,
  /** @export */ $: __embind_register_float,
  /** @export */ _: __embind_register_function,
  /** @export */ u: __embind_register_integer,
  /** @export */ F: __embind_register_iterable,
  /** @export */ m: __embind_register_memory_view,
  /** @export */ z: __embind_register_optional,
  /** @export */ Wa: __embind_register_smart_ptr,
  /** @export */ Va: __embind_register_std_string,
  ...
  /** @export */ Ua: __embind_register_void,
  /** @export */ L: __emval_await,
  /** @export */ g: __emval_create_invoker,
  /** @export */ b: __emval_decref,
  /** @export */ E: __emval_get_global,
  /** @export */ w: __emval_get_property,
  /** @export */ l: __emval_incref,
  /** @export */ f: __emval_invoke,
  /** @export */ Ta: __emval_is_string,
  /** @export */ x: __emval_new_cstring,
  /** @export */ e: __emval_run_destructors,
  ...
  /** @export */ j: _emscripten_get_now,
  /** @export */ Y: _emscripten_has_asyncify,
  /** @export */ Ka: _emscripten_outn,
  /** @export */ Ja: _emscripten_pc_get_function,
  /** @export */ Ia: _emscripten_resize_heap,
  /** @export */ X: _emscripten_sleep,
  /** @export */ W: _emscripten_stack_snapshot,
  /** @export */ Ha: _emscripten_stack_unwind_buffer,
  /** @export */ V: _emscripten_webgpu_get_device,
  /** @export */ Ga: _emwgpuBufferDestroy,
  /** @export */ Fa: _emwgpuBufferGetConstMappedRange,
  /** @export */ Ea: _emwgpuBufferGetMappedRange,
  /** @export */ Da: _emwgpuBufferMapAsync,
  /** @export */ Ca: _emwgpuBufferUnmap,
  /** @export */ Ba: _emwgpuBufferWriteMappedRange,
  /** @export */ k: _emwgpuDelete,
  /** @export */ Aa: _emwgpuDeviceCreateBuffer,
  /** @export */ za: _emwgpuDeviceCreateComputePipelineAsync,
  /** @export */ ya: _emwgpuDeviceCreateShaderModule,
  /** @export */ xa: _emwgpuDeviceDestroy,
  /** @export */ wa: _emwgpuQueueOnSubmittedWorkDone,
  ...
  /** @export */ ab: _fd_seek,
  /** @export */ H: _fd_write,
  /** @export */ J: hardware_concurrency,
  /** @export */ $a: _proc_exit,
  /** @export */ _a: _random_get,
  /** @export */ T: _wgpuBufferGetSize,
  /** @export */ ua: _wgpuBufferGetUsage,
  /** @export */ p: _wgpuCommandEncoderBeginComputePass,
  /** @export */ I: _wgpuCommandEncoderClearBuffer,
  /** @export */ v: _wgpuCommandEncoderCopyBufferToBuffer,
  /** @export */ ta: _wgpuCommandEncoderCopyBufferToTexture,
  /** @export */ sa: _wgpuCommandEncoderCopyTextureToBuffer,
  /** @export */ ra: _wgpuCommandEncoderCopyTextureToTexture,
  /** @export */ i: _wgpuCommandEncoderFinish,
  /** @export */ qa: _wgpuCommandEncoderResolveQuerySet,
  /** @export */ q: _wgpuComputePassEncoderDispatchWorkgroups,
  /** @export */ o: _wgpuComputePassEncoderEnd,
  /** @export */ pa: _wgpuComputePassEncoderSetBindGroup,
  /** @export */ S: _wgpuComputePassEncoderSetPipeline,
  /** @export */ oa: _wgpuDeviceCreateBindGroup,
  /** @export */ na: _wgpuDeviceCreateBindGroupLayout,
  /** @export */ h: _wgpuDeviceCreateCommandEncoder,
  /** @export */ ma: _wgpuDeviceCreateComputePipeline,
  /** @export */ la: _wgpuDeviceCreatePipelineLayout,
  /** @export */ ka: _wgpuDeviceCreateQuerySet,
  /** @export */ ja: _wgpuDeviceCreateTexture,
  /** @export */ D: _wgpuDeviceGetAdapterInfo,
  /** @export */ ia: _wgpuDeviceGetLimits,
  /** @export */ ha: _wgpuDeviceHasFeature,
  /** @export */ d: _wgpuQueueSubmit,
  /** @export */ R: _wgpuQueueWriteBuffer,
  /** @export */ ga: _wgpuQueueWriteTexture,
  /** @export */ fa: _wgpuTextureCreateView,
  /** @export */ ea: _wgpuTextureDestroy,
  /** @export */ Q: _wgpuTextureGetDepthOrArrayLayers,
  /** @export */ C: _wgpuTextureGetHeight,
  /** @export */ P: _wgpuTextureGetWidth
};
...
function applySignatureConversions(wasmExports) {
  ...
  wasmExports["Vc"] = makeWrapper_pp(wasmExports["Vc"]);
  wasmExports["Wc"] = makeWrapper_ppp(wasmExports["Wc"]);
  wasmExports["Xc"] = makeWrapper_ppp(wasmExports["Xc"]);
  wasmExports["Zc"] = makeWrapper_pp(wasmExports["Zc"]);
  wasmExports["_c"] = makeWrapper_p(wasmExports["_c"]);
  return wasmExports;
}
